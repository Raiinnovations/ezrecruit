    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden hero-gradient pt-20">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          {/* AI Powered ATS Badge - positioned at top right corner overlapping */}
          <motion.div
            animate={{ y: [0, -6, 0] }}
            transition={{ duration: 3, repeat: Infinity, ease: "easeInOut" }}
            className="absolute -top-4 right-16 glass-card rounded-xl px-4 py-2 hidden md:flex items-center gap-2 z-10 shadow-lg"
          >
            <div className="w-8 h-8 rounded-full bg-primary/20 flex items-center justify-center">
              <Zap size={16} className="text-primary" />
            </div>
            <span className="text-base font-semibold text-foreground whitespace-nowrap">AI Powered ATS</span>
          </motion.div>
        </motion.div>
      </div>
    </section>
